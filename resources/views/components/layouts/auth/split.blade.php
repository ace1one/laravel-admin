    ...
    <body class="min-h-screen bg-white antialiased dark:bg-linear-to-b ">
        <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            <div class="bg-muted relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r dark:border-neutral-800">
                ...
                <a class="relative z-20 flex items-center text-lg font-medium" wire:navigate>
            ...
            <div class="w-full lg:p-8">
                <div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    <a  class="z-20 flex flex-col items-center gap-2 font-medium lg:hidden" wire:navigate>
